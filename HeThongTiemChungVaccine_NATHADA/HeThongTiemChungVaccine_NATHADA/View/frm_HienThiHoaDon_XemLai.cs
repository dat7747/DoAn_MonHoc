...
{
    public partial class frm_HienThiHoaDon_XemLai : Form
    {
        ...
        public frm_HienThiHoaDon_XemLai(string maHoaDon, string tenDangNhap)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                string reportPath = @"D:\Final\Nam_New\HeThongTiemChungVaccine_NATHADA\HeThongTiemChungVaccine_NATHADA\HeThongTiemChungVaccine_NATHADA\HeThongTiemChungVaccine_NATHADA\View\Report_HoaDon_InLai.rpt";
        ...
        private void frm_HienThiHoaDon_XemLai_Load(object sender, EventArgs e)
        {
